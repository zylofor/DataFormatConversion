...
PROJECT_DIR ="/home/jzy/MyMountDisk/zylofor/location/dataset/test_sum"
ANN_DIR = PROJECT_DIR

# ==================== 需要修改 train or val ========================
COCO_JSON_FILE = ANN_DIR + 'train2017.json'  # json save path
VOC_XMLS_DIR = "/home/jzy/MyMountDisk/zylofor/location/dataset/test_sum"
# ==================================================================
...
def labelImg_voc2coco():
    ...
    for xml_fileName in (voc_xmls_list):
        ...
        for obj in get_elements(root, 'object'):
            ...
            seg = [xmin,ymin,xmax,ymin,xmin,ymax,xmax,ymax]
